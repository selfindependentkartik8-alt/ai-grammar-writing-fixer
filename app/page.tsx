...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-gradient-to-b from-[#063d31] via-[#020908] to-black text-white">
      ...
      <footer className="relative z-10 border-t border-[#76e6bd]/10 px-4 py-10">
        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-5 text-center sm:flex-row sm:text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border border-[#76e6bd]/20">
